<div class="accordion-container">
  <Accordion>
    <Panel color="secondary" bind:open={panel1Open}>
      <Header>
        Panel 1
    ...
    <Panel color="secondary" bind:open={panel2Open}>
      <Header>
        Panel 2
    ...
    <Panel color="secondary" bind:open={panel3Open}>
      <Header>
        Panel 3
    ...
    <Panel color="secondary" bind:open={panel4Open}>
      <Header>
        Panel 4
