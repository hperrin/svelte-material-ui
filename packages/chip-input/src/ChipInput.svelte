...
<script lang="ts">
  ...
  let {
    ...
    SmuiAttrs<'div', keyof OwnProps> & {
      ...
      [
        k in keyof ComponentProps<typeof ChipText> as `chipText\$${k}`
      ]?: ComponentProps<typeof ChipText>[k];
    } & {
      [
        k in keyof ComponentProps<
          typeof TrailingAction
        > as `chipTrailingAction\$${k}`
      ]?: ComponentProps<typeof TrailingAction>[k];
    } & {
      [
        k in keyof ComponentProps<typeof Autocomplete> as `autocomplete\$${k}`
      ]?: ComponentProps<typeof Autocomplete>[k];
    } & {
      [
      ...
      [
        k in keyof ComponentProps<typeof ListText> as `loading\$${k}`
      ]?: ComponentProps<typeof ListText>[k];
    } & {
      [
