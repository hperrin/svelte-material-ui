...
<section>
  ...
  <div>
    <Snackbar bind:this={mySnackbarWithClose}>
    ...
    <Snackbar bind:this={mySnackbarWithoutClose}>
      <Label>This is a snackbar.</Label>
    </Snackbar>

    <Button on:click={() => mySnackbarWithClose.open()}
      ><Label>Open Snackbar With Dismiss</Label></Button
    >
    <Button on:click={() => mySnackbarWithoutClose.open()}
      ><Label>Open Snackbar Without Dismiss</Label></Button
    >
  </div>
...
<script>
  ...
  let mySnackbarWithClose;
  let mySnackbarWithoutClose;
  let leadingSnackbar;
