...
<script>
  import Menu, {SelectionGroup, SelectionGroupIcon} from '../components/menu';
  import {Anchor} from '../components/menu-surface';
  import List, {Item, Separator, Text, Graphic} from '../components/list';
